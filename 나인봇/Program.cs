...
namespace NineDiscordBot
{
    class Program
    {
        ...
        public async Task BotMain()
        {
            ...
            await client.LoginAsync(TokenType.Bot, "OTMxNzc1MDA4MTEwNDE1ODcy.YeJVGQ.xyDLYD7O5rupcHqcxEd61pbeBuU"); //봇의 토큰을 사용해 서버에 로그인
        ...
        private async Task OnClientMessage(SocketMessage arg)
        {
            ...
            //메시지 앞에 커맨드태그가 달려있지 않고, 자신이 호출된게 아니거나 다른 봇이 호출했다면 취소
